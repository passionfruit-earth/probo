...
export const ISO27001_FRAMEWORK: FrameworkImport = {
  framework: {
    id: "iso27001-2022",
    name: "ISO 27001:2022",
    controls: [
      ...
      {
        id: "A.5.23",
        name: "A.5.23 - Information Security for Use of Cloud Services",
        description:
      ...
      // A.6 - People Controls
      {
        ...
        description:
          "Background verification checks on all candidates to become personnel shall be carried out prior to joining the organization and on an ongoing basis taking into consideration applicable laws, regulations and ethics.",
      },
      {
        id: "A.6.2",
